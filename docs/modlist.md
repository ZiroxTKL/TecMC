...
## Phase 1A - Performance Base

| Mod | Side | Purpose | Status |
|---|---|---|---|
| spark | Server / Client | Performance profiler, TPS/MSPT, CPU/RAM diagnostics | Added |
| Chunky | Server / Client | Chunk pregeneration and world generation control | Added |
| ModernFix | Server / Client | Performance improvements, memory reduction and bug fixes | Added |
| FerriteCore | Server / Client | Memory usage optimization | Added |

## Phase 1B - Entity and Logic Optimization
...
## Phase 5A - YUNG Base Structures

| Mod | Side | Purpose | Status |
|---|---|---|---|
| YUNG's API | Server / Client | Core dependency required by YUNG structure mods | Added |
| YUNG's Better Dungeons | Server / Client | Improves vanilla dungeons and adds better underground exploration | Added |
| YUNG's Better Mineshafts | Server / Client | Improves mineshafts with larger and more interesting layouts | Added |
| YUNG's Better Strongholds | Server / Client | Improves strongholds and makes End progression more interesting | Added |

## Phase 5B - YUNG Extra Vanilla Structures
